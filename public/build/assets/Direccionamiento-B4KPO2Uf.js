import{b as j,j as e,a as i}from"./app-CfLLNdmq.js";import{A as N}from"./AppLayout-EDKBJxYp.js";import{S as s}from"./sweetalert2.esm.all-Y6IUEg8t.js";import{T as x}from"./trending-up-D5p1E8xx.js";import{B as I,C as E,D as M,T as D,a as k}from"./target-DMxPMFM3.js";import{A as P}from"./activity-Dh8v90EF.js";import{H as T}from"./heart-5j-EsONP.js";import{S as U}from"./shield-Dr6XqQia.js";import{M as S}from"./map-BgXcp3pF.js";import{C as A}from"./calendar-e8AbeTsr.js";import{S as L}from"./settings-ijcIjcLY.js";import{U as F}from"./users-BXwvUrLF.js";import{C as _}from"./chart-column-DBfHNYAD.js";import{F as c}from"./file-text-DphGZlmb.js";import{P as $}from"./plus-DzJKngM-.js";/* empty css            */import"./auth-COE2-MdM.js";import"./authHistoryManager-C0uFoHhB.js";import"./user-DyeritmU.js";import"./createLucideIcon-1XNmPS5_.js";import"./chevron-down-1ADLUvqm.js";import"./log-out-BSiEpDiH.js";const z={FileText:c,BarChart3:_,PieChart:k,Target:D,TrendingUp:x,Users:F,Settings:L,Database:M,Calendar:A,Clock:E,Map:S,Shield:U,Heart:T,Activity:P,Briefcase:I};function de(){const{props:n}=j(),m=n.auth?.user,u=n.modules||[],p=n.canCreateModules||!1,b=m?.role==="Gerencia",v=m?.role==="Administrador",f="Direccionamiento",y=[{value:"FileText",label:"Documento"},{value:"BarChart3",label:"Gráfico de Barras"},{value:"PieChart",label:"Gráfico Circular"},{value:"TrendingUp",label:"Tendencia"},{value:"Target",label:"Objetivo"},{value:"Users",label:"Usuarios"},{value:"Settings",label:"Configuración"},{value:"Database",label:"Base de Datos"},{value:"Calendar",label:"Calendario"},{value:"Clock",label:"Reloj"},{value:"Map",label:"Mapa"},{value:"Shield",label:"Escudo"},{value:"Heart",label:"Corazón"},{value:"Activity",label:"Actividad"},{value:"Briefcase",label:"Maletín"}],w=a=>{a.route?i.get(a.route):a.name==="plan-desarrollo"&&i.get("/plan-desarrollo")},h=async()=>{const{value:a}=await s.fire({title:"Crear Nuevo Contenido",html:`
