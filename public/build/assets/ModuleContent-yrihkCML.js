import{j as o,a as h}from"./app-eMW6fhcD.js";import{S as g}from"./sweetalert2.esm.all-Y6IUEg8t.js";import{c as l}from"./sweetAlert-DJK8XZI4.js";import{P as N}from"./plus-DUkOzSkF.js";import{c as b}from"./createLucideIcon-DaAurRCC.js";import{T as S}from"./trash-2-CRpiVRaG.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const M=[["path",{d:"M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z",key:"1a8usu"}]],$=b("Pen",M);function O({module:t,submodules:u,displayName:y,icon:w,canManageContent:_=!1}){const x=_,f=u.some(e=>e.content_type==="powerbi"),v=u.length>0,C=async()=>{const e=t&&t.parent_id!==null&&t.parent_id!==void 0;let c="",a="";e?(c='<option value="powerbi">Power BI</option>',a=""):(c='<option value="module">Submódulo</option>',a="");const m=e&&f?'<p class="text-sm text-amber-600 bg-amber-50 p-2 rounded mb-2">⚠️ Ya existe un Power BI en este submódulo. Solo se permite uno por submódulo.</p>':"",{value:d}=await l.fire({title:"Agregar Contenido",html:`
