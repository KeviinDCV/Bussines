...
import { TrendingUp, Target, BarChart3, PieChart, FileText, Users, Settings, Database, Calendar, Clock, Map, Shield, Heart, Activity, Briefcase } from 'lucide-react';
...
export default function DireccionamientoGerencia() {
    ...
    return (
        <AppLayout
            ...
            pageTitle="Direccionamiento (Gerencia)"
