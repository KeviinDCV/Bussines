...
export default function AsistencialesGerencia() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <Head title="Gerencia - Asistenciales - Business Intelligence HUV" />
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold">Gerencia - Asistenciales</h1>
            ...
            <div className="max-w-7xl mx-auto p-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 items-stretch">
                    {/* All modules without permission checks since this is for Gerencia role */}
                    <div className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 p-4 sm:p-6 border-l-4 border-[#2a3d85] flex flex-col">
                        ...
                        <button 
                            onClick={() => router.get('/asistenciales/urgencias?from=gerencia')}
                    ...
                    <div className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 p-4 sm:p-6 border-l-4 border-[#2a3d85] flex flex-col">
                        ...
                        <button 
                            onClick={() => router.get('/asistenciales/ambulatorio?from=gerencia')}
                            className="w-full bg-[#2a3d85] hover:bg-[#1e2d5f] text-white py-2 px-4 rounded-lg transition-colors text-xs sm:text-sm font-medium mt-auto"
                        >
                            Acceder al Módulo
                        </button>
                    ...
                    <div className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 p-4 sm:p-6 border-l-4 border-[#2a3d85] flex flex-col">
                        ...
                        <button 
                            onClick={() => router.get('/asistenciales/laboratorio?from=gerencia')}
                            className="w-full bg-[#2a3d85] hover:bg-[#1e2d5f] text-white py-2 px-4 rounded-lg transition-colors text-xs sm:text-sm font-medium mt-auto"
                        >
                            Acceder al Módulo
                        </button>
