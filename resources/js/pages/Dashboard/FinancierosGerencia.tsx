...
import { ArrowLeft, User, LogOut, ChevronDown, Shield, DollarSign } from 'lucide-react';
...
export default function FinancierosGerencia() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <Head title="Gerencia - Financieros - Business Intelligence HUV" />
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold">Gerencia - Financieros</h1>
            ...
            <div className="max-w-7xl mx-auto p-6">
                <div className="bg-white rounded-lg shadow-sm p-6">
                    <h2 className="text-2xl font-bold text-gray-900 mb-6">Módulos Financieros</h2>
                    <div className="text-center py-12">
                        <DollarSign className="w-16 h-16 text-[#2a3d85] mx-auto mb-4" />
                        <p className="text-gray-600">
                            Los módulos financieros están siendo desarrollados.
                            <br />
                            Pronto estarán disponibles con todas las funcionalidades.
                        </p>
                    </div>
                </div>
            </div>
