...
import { DollarSign, Calculator, PiggyBank, Wallet, FileText, AlertTriangle, BookOpen } from 'lucide-react';
...
export default function FinancierosGerencia() {
    ...
    return (
        <AppLayout
            title="Gerencia - Financieros - Business Intelligence HUV"
            pageTitle="Financieros - Gerencia"
            pageDescription="Subgerencia Financiera - Vista Gerencial"
            icon={DollarSign}
            showBackButton={true}
