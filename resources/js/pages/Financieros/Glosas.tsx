...
export default function Glosas() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <Head title="Glosas - Business Intelligence HUV" />
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold">Glosas</h1>
                                <p className="opacity-90">Gestión de glosas y objeciones de facturación</p>
                            </div>
                        </div>
                ...
                <div className="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-600">
                            El módulo de Glosas está siendo desarrollado.
                            <br />
