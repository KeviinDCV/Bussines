...
import { PiggyBank, ArrowLeft, User, LogOut, ChevronDown } from 'lucide-react';
...
export default function Recaudo() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <Head title="Recaudo - Business Intelligence HUV" />
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold">Recaudo</h1>
                                <p className="opacity-90">Control de ingresos y recaudos hospitalarios</p>
                            </div>
                        </div>
            ...
            <main className="max-w-7xl mx-auto p-6">
                <div className="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <div className="text-center py-12">
                        <PiggyBank className="w-16 h-16 text-[#2a3d85] mx-auto mb-4" />
                        <p className="text-gray-600">
                            El módulo de Recaudo está siendo desarrollado.
                            <br />
