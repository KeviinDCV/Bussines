...
import { BookOpen, ArrowLeft, User, LogOut, ChevronDown } from 'lucide-react';
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="opacity-90">Registro contable y estados financieros</p>
                            </div>
                        </div>
            ...
            <main className="max-w-7xl mx-auto p-6">
                <div className="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <div className="text-center py-12">
                        <BookOpen className="w-16 h-16 text-[#2a3d85] mx-auto mb-4" />
                        <p className="text-gray-600">
                            El módulo de Contabilidad está siendo desarrollado.
                            <br />
