...
export default function SubmoduloDePrueba() {
    const { props } = usePage();
    ...
    return (
        <AppLayout
            title="Submodulo de prueba - Tableros de Gestión HUV"
            pageTitle="Submodulo de prueba"
            pageDescription="Submodulo de prueba"
            icon={FolderOpen}
            showBackButton={true}
            backUrl={getBackUrl()}
        >
