...
import { Scissors, ArrowLeft, User, LogOut, ChevronDown } from 'lucide-react';
...
export default function Cirugia() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <Head title="Gestión integral de Cirugía - Business Intelligence HUV" />
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold">Gestión integral de Cirugía</h1>
                                <p className="opacity-90">Control de quirófanos y procedimientos quirúrgicos</p>
                            </div>
                        </div>
            ...
            <main className="max-w-7xl mx-auto p-6">
                <div className="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <div className="text-center py-12">
                        <Scissors className="w-16 h-16 text-[#2a3d85] mx-auto mb-4" />
                        <p className="text-gray-600">
                            El módulo de Gestión integral de Cirugía está siendo desarrollado.
                            <br />
