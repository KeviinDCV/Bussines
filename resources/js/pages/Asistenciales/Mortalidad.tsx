...
export default function Mortalidad() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <Head title="Mortalidad - Business Intelligence HUV" />
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold">Mortalidad</h1>
                                <p className="opacity-90">Análisis y seguimiento de indicadores de mortalidad</p>
                            </div>
                        </div>
                ...
                <div className="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-600">
                            El módulo de Mortalidad está siendo desarrollado.
                            <br />
