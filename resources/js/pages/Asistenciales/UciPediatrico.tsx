...
export default function UciPediatrico() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <Head title="UCI Pediátrico - Business Intelligence HUV" />
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold">UCI Pediátrico</h1>
                                <p className="opacity-90">Unidad de Cuidados Intensivos Pediátricos</p>
                            </div>
                        </div>
