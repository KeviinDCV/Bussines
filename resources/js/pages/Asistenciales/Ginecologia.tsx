...
export default function Ginecologia() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <Head title="Gestión integral de Ginecología y Obstetricia - Business Intelligence HUV" />
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="opacity-90">Atención especializada en salud femenina y materna</p>
                            </div>
                        </div>
