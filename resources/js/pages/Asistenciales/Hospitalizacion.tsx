...
import { Building2, ArrowLeft, User, LogOut, ChevronDown } from 'lucide-react';
...
export default function Hospitalizacion() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <Head title="Gestión integral de Hospitalización - Business Intelligence HUV" />
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold">Gestión integral de Hospitalización</h1>
                                <p className="opacity-90">Control de pacientes hospitalizados y servicios de internación</p>
                            </div>
                        </div>
            ...
            <main className="max-w-7xl mx-auto p-6">
                <div className="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <div className="text-center py-12">
                        <Building2 className="w-16 h-16 text-[#2a3d85] mx-auto mb-4" />
