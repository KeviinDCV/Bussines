...
export default function Epidemiologia() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <Head title="Epidemiología - Business Intelligence HUV" />
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold">Epidemiología</h1>
                                <p className="opacity-90">Vigilancia epidemiológica y control de enfermedades</p>
                            </div>
                        </div>
            ...
            <main className="max-w-7xl mx-auto p-6">
                <div className="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <div className="text-center py-12">
                        <TrendingUp className="w-16 h-16 text-[#2a3d85] mx-auto mb-4" />
