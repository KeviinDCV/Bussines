...
import { BarChart3, ArrowLeft, User, LogOut, ChevronDown } from 'lucide-react';
...
export default function Indicadores() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <Head title="Indicadores - Business Intelligence HUV" />
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                        <div className="flex items-center">
                            ...
                            <div>
                                <h1 className="text-lg sm:text-2xl font-bold">Indicadores</h1>
                                <p className="text-sm sm:text-base opacity-90">Métricas e indicadores de calidad</p>
                            </div>
                        </div>
