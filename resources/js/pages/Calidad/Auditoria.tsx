...
import { Search, ArrowLeft, User, LogOut, ChevronDown } from 'lucide-react';
...
export default function Auditoria() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <Head title="Auditoría - Business Intelligence HUV" />
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                        <div className="flex items-center">
                            ...
                            <Search className="w-6 h-6 sm:w-8 sm:h-8 mr-3" />
                            <div>
                                <h1 className="text-lg sm:text-2xl font-bold">Auditoría</h1>
                                <p className="text-sm sm:text-base opacity-90">Auditorías internas y externas</p>
                            </div>
                        </div>
