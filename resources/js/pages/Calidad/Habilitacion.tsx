...
import { Settings, ArrowLeft, User, LogOut, ChevronDown } from 'lucide-react';
...
export default function Habilitacion() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <Head title="Habilitación - Business Intelligence HUV" />
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                        <div className="flex items-center">
                            ...
                            <Settings className="w-6 h-6 sm:w-8 sm:h-8 mr-3" />
                            <div>
                                <h1 className="text-lg sm:text-2xl font-bold">Habilitación</h1>
                                <p className="text-sm sm:text-base opacity-90">Procesos de habilitación y acreditación</p>
                            </div>
                        </div>
            ...
            <main className="max-w-7xl mx-auto p-4 sm:p-6">
                <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6">
                    ...
                    <div className="text-center py-12">
                        <Settings className="w-12 h-12 sm:w-16 sm:h-16 text-[#2a3d85] mx-auto mb-4" />
                        <p className="text-gray-600">
                            El módulo de Habilitación está siendo desarrollado.
                            <br />
