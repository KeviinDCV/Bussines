...
import { Headphones, ArrowLeft, User, LogOut, ChevronDown } from 'lucide-react';
...
export default function CentroEscucha() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <Head title="Centro de Escucha - Business Intelligence HUV" />
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                        <div className="flex items-center">
                            ...
                            <Headphones className="w-6 h-6 sm:w-8 sm:h-8 mr-3" />
                            <div>
                                <h1 className="text-lg sm:text-2xl font-bold">Centro de Escucha</h1>
                                <p className="text-sm sm:text-base opacity-90">Atención y seguimiento a usuarios</p>
                            </div>
                        </div>
                ...
                <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6">
                    ...
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-600">
                            El módulo Centro de Escucha está siendo desarrollado.
                            <br />
