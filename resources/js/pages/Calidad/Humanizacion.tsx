...
import { Heart, ArrowLeft, User, LogOut, ChevronDown } from 'lucide-react';
...
export default function Humanizacion() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <Head title="Humanización - Business Intelligence HUV" />
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                        <div className="flex items-center">
                            ...
                            <Heart className="w-6 h-6 sm:w-8 sm:h-8 mr-3" />
                            <div>
                                <h1 className="text-lg sm:text-2xl font-bold">Humanización</h1>
                                <p className="text-sm sm:text-base opacity-90">Programa de humanización en salud</p>
                            </div>
                        </div>
