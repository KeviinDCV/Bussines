...
import { Pill, ArrowLeft, User, LogOut, ChevronDown } from 'lucide-react';
...
export default function Farmacia() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <Head title="Farmacia - Business Intelligence HUV" />
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="opacity-90">Gestión farmacéutica y medicamentos</p>
                            </div>
                        </div>
            ...
            <main className="max-w-7xl mx-auto p-6">
                <div className="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <div className="text-center py-12">
                        <Pill className="w-16 h-16 text-[#2a3d85] mx-auto mb-4" />
